...
export const orgStructureData = [
  ...
  { role: "Protege (AI Data Engineer)", name: "Muhammad Shazwi Haziq Bin Hazlisham", responsibility: "Supports data engineering, AI-ready dataset preparation, pipeline documentation, testing, and analytics delivery on a temporary protege assignment.", focus: "Data Preparation, Testing, Analytics Support", photo: "protege-ai-data-engineer.png" },
